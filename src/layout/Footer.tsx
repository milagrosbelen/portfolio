...
export function Footer() {
  return (
    <footer data-nav-theme="dark" className="relative pb-[max(0.5rem,env(safe-area-inset-bottom))]">
      <SectionGlow variant="black" />
      <div className="site-container relative z-10 flex flex-col items-center py-12 text-center">
