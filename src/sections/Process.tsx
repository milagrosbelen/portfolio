    ...
    >
      ...
      <div className="site-container relative">
        ...
        <motion.div
          ...
          className="relative mx-auto mt-12 w-full max-w-[21rem] sm:mt-16 sm:max-w-[24.5rem] lg:hidden"
        >
        ...
        <motion.ol
          ...
          className="relative mt-24 hidden lg:grid lg:grid-cols-4 lg:gap-10 xl:gap-16"
        >
          <div
            aria-hidden="true"
            className="absolute top-[18px] right-[8%] left-[8%] h-px bg-gradient-to-r from-transparent via-accent to-transparent"
          />
          ...
          {processSteps.map((step) => (
            ...
            >
              <span className="relative z-10 inline-flex h-9 w-9 items-center justify-center rounded-full border border-accent/70 bg-ink text-[11px] font-semibold tracking-[0.12em] text-white shadow-[0_0_18px_rgba(99,91,255,0.45)]">
                {step.number}
              </span>
              ...
              {(() => {
                const Icon = icons[step.icon]
                return <Icon className="mt-5 h-6 w-6 text-white/75" />
              })()}
        ...
        <motion.div
          ...
          className="mx-auto mt-12 max-w-md text-center lg:mt-24"
        >
          <motion.div
            ...
            className="relative mx-auto mb-7 h-11 w-px origin-top bg-gradient-to-b from-accent/80 to-transparent lg:hidden"
          >
